      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-gradient-to-br from-[#0b4fd8] via-[#216bff] to-[#7db4ff] text-white rounded-[32px] p-8 shadow-xl overflow-hidden relative">
            ...
            <div className="mt-8">
              <p className="font-bold text-lg mb-4">HUBUNGI KAMI</p>
          ...
          <div className="bg-white rounded-[32px] p-6 shadow">
            <h3 className="text-xl font-black mb-4">Kategori</h3>
        ...
        <div id="products" className="flex justify-between items-end mb-5">
          <div>
            <p className="text-[#0b4fd8] font-bold">Produk</p>
            <h2 className="text-3xl font-black">Produk Tersedia</h2>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <h3 className="text-xl font-black mt-3">{product.name}</h3>
        ...
        <div className="mt-16">
          <div className="mb-6">
            <p className="text-[#0b4fd8] font-bold">Review Customer</p>
            <h2 className="text-3xl font-black">Rating & Review</h2>
          </div>

          {reviews.length === 0 ? (
            <div className="bg-white rounded-[28px] p-8 shadow text-center">
